                ...
                <form action="?controller=article&action=update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <select name="category_id" id="">
                            <?php foreach ($categories as $category){?>
                                ...
                                <?php
                                     if ($article->getCat_id()== $category->getId()){ ?>
                                     selected
                                     <?php } ?>>
                                <?= $category->getName()?>
                                </option>
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <?php foreach ($authors as $author){?>
                                ...
                                <?php
                                     if ($article->getAu_id()== $author->getId()){ ?>
                                     selected
                                     <?php } ?>>
                                <?= $author->getName()?>
                                </option>
                    ...
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Ảnh cũ</span>
                        <img height="100" src="assets/images/songs/<?php echo $article->getImage() ?> " alt="">
                        <input type="hidden" name="image_old" value="<?php echo $article->getImage() ?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Đổi ảnh</span>
