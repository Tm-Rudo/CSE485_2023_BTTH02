...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active fw-bold" href="?controller=Author&action=list">Tác giả</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
        <form action="?controller=author&action=add_process" method="post" enctype="multipart/form-data">
        <h3 class="text-center text-uppercase fw-bold">Thêm mới tác giả</h3> <br>
<!-- 
        <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblAutId">Mã tác giả</span>
                        <input type="text" class="form-control" name="txtAutId" value="" >
                    </div> -->
