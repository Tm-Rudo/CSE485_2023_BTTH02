        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="?controller=category&action=list">Thể loại</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $each->getName() ?></td>
                                    <td>
                                        <a href="?controller=Category&action=edit&id=<?=$each->getId()?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                    </td>
                                    <td>
                                        <a href="?controller=Category&action=delete&id=<?=$each->getId()?>"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
