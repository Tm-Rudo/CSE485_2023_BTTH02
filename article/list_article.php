                    ...
                    <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $each->getAu_name() ?></td>
                                    <td><?= $each->getDate() ?></td>
                                    
                                    <td>
                                    <img height="100" src="assets/images/songs/<?php echo $each->getImage() ?>" >
                                    </td>
                                    <td>
                                        <a href="?controller=Article&action=edit&id=<?=$each->getId()?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                    </td>
                                    <td>
                                        <a href="?controller=Article&action=delete&id=<?=$each->getId()?>"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
